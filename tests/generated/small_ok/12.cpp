...
TEST(service_config_parse, small_ok_12)
{
    using namespace std::chrono_literals;

    const std::string json = load_file("small_ok/12.json");
    ...
    const data::service_config expected = data::service_config{
        ...
        .config_tree              = data::scope_override{
            .scope                    = "KVMZCABVQHCNODVN",
            .extra                    = boost::json::value_from("RKTRFWBRFQCMTNVTPPTMRAUXCGZVILL"),
